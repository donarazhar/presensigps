{{-- Function menghitung keterlambatan --}}
@php
...
@foreach ($presensi as $d)
    ...
    {{-- Menampilkan kolom yang statusnya hadir --}}
    @if ($d->status == 'h')
        <tr>
            ...
            <td>{!! $d->jam_out != null ? $d->jam_out : '<span class="badge bg-danger text-bg-dark">Belum Absen</span>' !!}</td>
            <td>
                @if ($d->jam_out != null)
            ...
            <td>
                <a href="#" class="btn btn-primary btn-xd tampilkanpeta" id="{{ $d->id }}"><svg
    ...
    @else
        <tr>
            ...
            <td>
                @if ($d->status == 'i')
                    <span class="badge bg-warning text-bg-dark">Izin</span>
                @elseif ($d->status == 's')
                    <span class="badge bg-info text-bg-dark">Sakit</span>
                @elseif ($d->status == 'c')
                    <span class="badge bg-primary text-bg-dark">Cuti</span>
                @endif
            <td>{{ $d->keterangan }}</td>
            <td></td>
        </tr>
