    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $cuti->kode_cuti }}" class="form-control" name="kode_cuti"
                    id="kode_cuti" placeholder="Kode Cuti" readonly>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $cuti->nama_cuti }}" class="form-control" name="nama_cuti"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $cuti->jml_hari }}" class="form-control" name="jml_hari" id="jml_hari"
